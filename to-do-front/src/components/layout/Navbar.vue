  ...
  <div class="navbar bg-base-100 shadow-lg mb-8 rounded-box relative z-[100]">
    ...
    <div class="navbar-start">
      ...
      <div class="dropdown sm:hidden">
        ...
        <ul
          tabindex="0"
          class="menu menu-md dropdown-content mt-3 z-[101] p-3 shadow-2xl bg-base-100 rounded-box w-64 border border-white/5"
        >
          ...
          <li v-if="authStore.isAdmin">
            <router-link
              ...
              @click="closeDropdown"
              class="text-lg font-bold py-3"
              active-class="active bg-accent/20 text-accent"
          ...
          <li
            class="menu-title text-sm font-black uppercase tracking-widest opacity-50 px-4 py-2"
          >
            Tema
          </li>
    ...
    <div class="navbar-center hidden sm:flex">
      <ul class="menu menu-horizontal px-1 gap-1">
        ...
        <li v-if="authStore.isAdmin">
          <router-link
            :to="{ name: 'users' }"
            class="btn btn-ghost btn-sm normal-case font-semibold"
            active-class="btn-active bg-accent/10 text-accent border-accent"
            >Usuarios</router-link
          >
        </li>
      </ul>
